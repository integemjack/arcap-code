...
!(function(e, n) {
	...
	var a,
		...
		R = function(e, n, t) {
			s.push({ command: e, callback: n, originalPhrase: t }), d && k("Command successfully loaded: %c" + t, p);
		},
		P = function(e) {
			var n;
			S(u.result, e);
			for (var t = 0; t < e.length; t++) {
				...
				for (var o = 0, r = s.length; o < r; o++) {
					...
					if (a) {
						var c = a.slice(1);
						return (
							d && (k("command matched: %c" + i.originalPhrase, p), c.length && k("with parameters", c)),
	...
	return (t = {
		...
		addCallback: function(e, n, t) {
			var o = r[n] || n;
			"function" == typeof o && u[e] !== i && u[e].push({ callback: o, context: t || this });
		},
		...
		trigger: function(e) {
			t.isListening()
				...
				: d && k(m ? "Speech heard, but annyang is paused" : "Cannot trigger while annyang is aborted");
		}
	});
});
